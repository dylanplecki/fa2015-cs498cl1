...
def play_round(lands_on_table, next_card_ind):
    ...
    **NOTE**: I was about to actually make this a non-closure, because
    ...
    for spell_value in range(1, min(lands_on_table + 1, 6), 1):
...
It is properly shuffled, and you draw seven cards. At each turn, you
play a land if it is in your hand, and you always only play the cheapest spell
in your hand that you are able to play and you never play two spells.

Part b: Write a program to estimate the probability that the first spell you
play has cost 4."
"""
...
for exp in range(n_experiments):
    for sim in range(n_simulations):
        ...
        # From here, it's a matter of playing the game
        lands_on_table = 0
        next_card_ind = 7
        while True:
